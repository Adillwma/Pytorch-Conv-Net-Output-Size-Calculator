...
#%% - User Inputs
conv_type = 0 #Select conv type: 0=conv2D, 1=conv2D.Transpose, 2=conv3D, 3=conv3D.Transpose (WARNING: Values other than 0-3 will select conv3D.Transpose)

H_in = 7         # height of the inputs
W_in = 7         # width of the inputs
D_in = None         # depth of the input (Only used if one of the 3D conv types is selected above)
...
D = 1              # dilation (can be an integer of a two-value-integer tuple) (D=1 has no dilation)
